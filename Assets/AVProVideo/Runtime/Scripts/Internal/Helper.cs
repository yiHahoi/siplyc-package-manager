...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion             = "2.1.3";
		public const string ExpectedPluginVersion_Windows = "2.1.3";
		public const string ExpectedPluginVersion_WinRT   = "2.1.3";
		public const string ExpectedPluginVersion_Android = "2.1.2";
